  ...
  const getColorBackground = () => {
    switch (color) {
      ...
      case ColorEnum.SECONDARY:
        return "bg-[#2B2D31] hover:bg-[#1E1F22] group-hover:bg-[#1E1F22]"; // Dark sidebar background with hover effect
      ...
      case ColorEnum.TRANSPARENT:
        return "bg-transparent hover:bg-[#2B2D31]"; // Transparent background with hover effect
      case ColorEnum.DARK:
      default:
